    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            Experience a study planner that understands your habits, adapts to
            your productivity, and helps you achieve better results without
            burnout.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 mt-8 text-center">
            <Link to="/demo">
              <button
                style={{
