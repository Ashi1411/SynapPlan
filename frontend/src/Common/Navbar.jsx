  ...
  return (
    ...
    >
        ...
        >
          <ul className="flex gap-[16px] font-semibold">
            ...
            <li>
              <Link
                to={"/"}
                className="inline-block transition duration-200 hover:font-bold hover:scale-105"
              >
                {" "}
                Home{" "}
              </Link>{" "}
      ...
      >
        ...
        >
          {/* Close Button */}
          <button className="text-xl self-end" onClick={() => setIsOpen(false)}>
            ✕
          </button>
          ...
          <Link onClick={() => setIsOpen(false)} to="/howitworks">
            How It Works
          </Link>
          <Link onClick={() => setIsOpen(false)} to="/demo">
            Demo
          </Link>
